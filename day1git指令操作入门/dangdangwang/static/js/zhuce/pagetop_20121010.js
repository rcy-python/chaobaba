...
function initHeaderOperate() {
    ...
    if (validatedflag == "1")
        marks = "（<a name=\"ddnav_verifymail\" href=\"https://login.user.com/VerifyEmail.aspx\">邮箱未验证</a>）";
    if (validatedflag == "2" || validatedflag == "3")
        marks = "（<a name=\"ddnav_verifymail\" href=\"https://login.user.com/VerifyEmail.aspx\">邮箱未验证</a>）";

    if (usernick == "")
        xinshou = "<a name=\"ddnav_login\" href=\"https://login.user.com/signin.aspx?returnurl=" + escape(location.href) + "\" target=\"_self\" class=\"login_link\">登录</a><a name=\"ddnav_register\" href=\"https://login.user.com/Register.aspx\" target=\"_self\" class=\"login_link\">免费注册</a>";
    else {
    ...
    if (usernick != '') {
        userlink = "<a href=\"http://my.user.com/myhome/homepage.aspx\" target=\"_blank\" class=\"login_link\">" + usernick + "</a>";
...
function changeuser() {
    ...
    nkname.innerHTML = '您好，欢迎光临当当网。<a href="http://reco.user.com/">当当为您推荐！</a>[请<a href="http://login.user.com/Signin.aspx" name="sign_in" target="_self" class="blue12a">登录</a>/<a href="http://login.user.com/Register.aspx" target="_self" name="Register" class="blue12a">注册</a>]';
}
