...
class Courses(BaseModel):
    ...
    teacher = models.ForeignKey("Teachers", on_delete=models.DO_NOTHING, null=True, blank=True, verbose_name="授课老师")
...
class CourseChapter(BaseModel):
    """课程章节"""
    course = models.ForeignKey("Courses", related_name='coursechapters', on_delete=models.CASCADE, verbose_name="课程名称")
...
class CourseLesson(BaseModel):
    ...
    course = models.ForeignKey("Courses", related_name="course_lesson", on_delete=models.CASCADE, verbose_name="课程")
